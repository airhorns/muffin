(function() {
  var CoffeeScript, ask, clocFile, clocPath, compileMap, compileScript, copyFile, doccoFile, ensurePerl, exec, extend, fs, getGitRoot, glob, growlAvailble, growlCommand, handleFileError, inRebase, k, langDefPath, minifyScript, notify, ofs, orgExec, path, perlError, perlPresent, printTable, q, readFile, run, runOptions, spawn, statFile, statFiles, temp, v, writeFile, _ref, _ref2, _statFiles;
  ...
  printTable = function(fields, results) {
    var data, field, headers, i, j, max, maxLengths, out, result, _i, _j, _len, _len2, _len3, _ref2, _ref3;
    headers = {};
      ...
      return ask('git ref A').then(function(refA) {
        return ask('git ref B').then(function(refB) {
          return getGitRoot().then(function(root) {
            ...
            var field, k, ref, result, resultSet, table, tableEntry, tableFields, v, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _len6, _m, _n, _name, _ref2;
            table = {};
