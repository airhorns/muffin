(function() {
  var CoffeeScript, ask, clocFile, clocPath, compileMap, compileScript, compileString, copyFile, doccoFile, ensurePerl, exec, extend, fs, getGitRoot, glob, growlAvailable, growlCheckPromise, growlCommand, handleFileError, inRebase, k, langDefPath, minifyScript, mkdir_p, notify, ofs, orgExec, path, perlError, perlPresent, printTable, q, readFile, run, runOptions, spawn, statFile, statFiles, temp, v, writeFile, _, _ref, _ref2, _ref3, _statFiles;
  ...
  compileString = function(coffeeSource, options) {
    ...
    return js = CoffeeScript.compile(coffeeSource, {
