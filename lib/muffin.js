(function() {
  var CoffeeScript, cloc, clocPath, compileMap, compileScript, copyFile, doccoFile, ensurePerl, exec, extend, fileStat, fs, glob, handleFileError, inRebase, k, langDefPath, minifyScript, notify, ofs, orgExec, path, q, readFile, run, spawn, statFiles, v, writeFile, _ref, _ref2;
  ...
  statFiles = function(files, options) {
    ...
    promises = files.map(function(file) {
      return q.join(cloc(file), fileStat(file), function(clocstats, filestats) {
