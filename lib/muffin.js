(function() {
  var CoffeeScript, clocFile, clocPath, compileMap, compileScript, copyFile, doccoFile, ensurePerl, exec, extend, fs, glob, growlAvailble, growlCommand, handleFileError, inRebase, k, langDefPath, minifyScript, notify, ofs, orgExec, path, perlError, perlPresent, q, readFile, run, runOptions, spawn, statFile, statFiles, v, writeFile, _ref, _ref2;
