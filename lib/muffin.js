(function() {
  var CoffeeScript, ask, clocFile, clocPath, compileMap, compileScript, compileString, copyFile, doccoFile, ensurePerl, exec, extend, fs, getGitRoot, glob, growlAvailable, growlCheckPromise, growlCommand, growlImagePath, handleFileError, inRebase, k, langDefPath, minifyScript, mkdir_p, notify, ofs, orgExec, path, perlError, perlPresent, printTable, q, readFile, run, runOptions, spawn, statFile, statFiles, temp, v, writeFile, _, _ref, _ref1, _ref2, _statFiles,
    __slice = [].slice;
      ...
      return ask('git ref A').then(function(refA) {
        return ask('git ref B').then(function(refB) {
          return getGitRoot().then(function(root) {
            ...
            var field, k, ref, result, resultSet, table, tableEntry, tableFields, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _name, _ref2;
            table = {};
